    ...
    T: PartialEq,
{
    ...
    /// by its state space.
    ///
    /// If you want to reset the chain of elements, use `self.initialize` methods.
    ...
    /// Resets the information of the element generated by the previous `self.next` method.
